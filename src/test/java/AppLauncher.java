...
public class AppLauncher {
    ...
    @Step("Hover <xpath> texts")
    public void hover(String xpath){
      
      WebElement ele = findElementByXpath(xpath);
    ...
    @Step("Send keys password element by id <id> text <encodePass>")
    public void decodePass(String id, String encodePass){

        sendKeysWithClear(By.id(id), decodeStr(encodePass));
